...
class AscendQuantConfig(QuantizationConfig):
    ...
    def __init__(self, quant_config: Dict[str, Any]):
        ...
        # print("[INFO] AscendQuantConfig initialized.!!!!!!!!!!!!!!!!!!!!")
    ...
    def get_quant_method(self, layer: torch.nn.Module,
        ...
        # print("Getting quant method for layer:", prefix)
        # print("Layer type:", type(layer))
        # print("self.packed_modules_mapping:", self.packed_modules_mapping)
        # print("quant_description sample:", list(self.quant_description.items())[:5])
        # import os
        # os._exit(0)
    ...
    def is_layer_skipped_ascend(
        ...
        # print("Checking proj_name:", proj_name)
        # print("fused_mapping:",fused_mapping)
        # print(self.quant_description[prefix + '.weight'])
        # print(self.quant_description)
